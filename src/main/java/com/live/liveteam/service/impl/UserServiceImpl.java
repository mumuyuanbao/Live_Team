...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public ResultVO<UserTokenVO> login(String code, String rawData, String signature, String encrypteData, String iv, Integer userIdevice, HttpServletRequest request) {
        ResultVO<UserTokenVO> result = new ResultVO<>();
        // 用户非敏感信息：rawData
        // 签名：signature
...
//            JSONObject userInfo = WechatUtil.getUserInfo(encrypteData, sessionKey, iv);
        ...
        userTokenVO.setToken(openid);
        redisUtil.set(RedisUtil.LOGIN_USER_STRING + openid, user, RedisUtil.USER_TOKEN_TIME);
        result.setCode(EnumResult.SUCCESS.getCode());
        result.setMsg(EnumResult.SUCCESS.getMsg());
        result.setData(userTokenVO);
        return result;
    }
